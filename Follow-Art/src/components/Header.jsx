    ...
    return (
        <header className={`header ${scrolled ? 'header--scrolled' : ''}`}>
            <div className="header-logo">
                <span className="header-logo-title">AMAN RAJ</span>
                <span className="header-logo-sub">AI Engineer & Developer</span>
            </div>
            ...
            <div className="header-actions">
                <ThemeToggle />
                <a href="https://github.com/Amanraj9910" target="_blank" rel="noopener noreferrer" className="header-action-link">
                ...
                <a href="https://linkedin.com/in/aman-raj-250081303/" target="_blank" rel="noopener noreferrer" className="header-action-link">

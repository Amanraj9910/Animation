import { d as h, m as o, c as l, o as n, n as r, a as s, H as i, e as m } from "./1IpmvU-P.js";
const p = {
    class: "underline-text-piece__content"
}
    , d = h({
        __name: "TextUnderlineAnimation",
        props: {
            show: {
                type: Boolean,
                default: !1
        ...
        setup(Z, { expose: t }) {
            ...
            return t({
                ...
                (e, c) => (n(),
                    l("span", {
                        ref: "text-underline",
                        class: r(["underline-text-piece", {
                            "underline-text-piece--shown": e.show
                        }, e.variant && `underline-text-piece--${e.variant}`])
                    }, [(n(),
                        l("svg", {
                            ...
                            viewBox: "0 0 82 4",
                            style: i({
                                "transition-delay": e.transitionDelay + "s"
                            })
                        }, c[0] || (c[0] = [s("path", {
                            fill: "currentColor",
                            "fill-rule": "evenodd",
                            ...
                            "clip-rule": "evenodd"
                        }, null, -1)]), 4)), s("span", p, [m(e.$slots, "default")])], 2))
        }
    })
    , _ = Object.assign(d, {
        __name: "TextUnderlineAnimation"
